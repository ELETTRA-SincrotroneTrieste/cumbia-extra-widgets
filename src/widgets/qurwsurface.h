...
class QuRWSurface : public QFrame
{
...
public:
    ...
    QuRWSurface(QWidget *parent = nullptr);
...
signals:
    ...
    void targetMoveFinished(const QVector<double> &xy);
...
public slots:
    ...
    void setX(double x);
    void setY(double y);
    void setXY(const QVector<double> &v);
    ...
    void setW(const QVector<double> & wv);
